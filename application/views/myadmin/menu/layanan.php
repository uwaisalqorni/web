...
<div class="container-fluid">
	...
	<div class="clearfix">
		...
		<div class="float-right">
				<a href="<?= base_url('myadmin/menu/layanan_add') ?>" class="btn btn-sm btn-primary btn-icon-split">
					<span class="icon">
					...
					?>
							<tr>
								...
								<th style="width: 90px;text-align: center;vertical-align: middle;">
									<a href="<?= base_url('myadmin/menu/layanan_edit/') . $x['id'] ?>" class="btn btn-circle btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-edit"></i></a>
									<a href="<?= base_url('myadmin/menu/layanan_detail/') . $x['id'] ?>" class="btn btn-circle btn btn-outline-warning btn-sm" data-toggle="tooltip" data-placement="bottom" title="Detail"><i class="fa fa-info"></i></a>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header bg-danger py-3">
					<h6 class="modal-title m-0 font-weight-bold text-white" id="exampleModalLabel">Delete Layanan</h6>
				...
				<div class="modal-footer py-2">
					<a href="<?= base_url('myadmin/menu/layanan_delete/') . $x['id']; ?>" class="btn btn-primary btn-sm btn-icon-split">
