...
<div class="container-fluid">
	...
	<div class="clearfix">
		...
		<div class="float-right">
				<a href="<?= base_url('myadmin/menu/foto_kategori_add') ?>" class="btn btn-sm btn-primary btn-icon-split">
					<span class="icon">
					...
					?>
							<tr>
								...
								<th style="width: 90px;text-align: center;vertical-align: middle;">
									<a href="<?= base_url('myadmin/menu/foto_kategori_edit/') . $x['id'] ?>" class="btn btn-circle btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-edit"></i></a>
...
<!-- Modal Delete-->
<?php foreach ($foto_kategori as $x) : ?>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header bg-danger py-3">
					<h6 class="modal-title m-0 font-weight-bold text-white" id="exampleModalLabel">Delete Kategori Foto</h6>
				...
				<div class="modal-footer py-2">
					<a href="<?= base_url('myadmin/menu/foto_kategori_delete/') . $x['id']; ?>" class="btn btn-primary btn-sm btn-icon-split">
