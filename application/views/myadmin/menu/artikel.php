...
<div class="container-fluid">
	...
	<div class="clearfix">
		...
		<div class="float-right">
				<a href="<?= base_url('myadmin/menu/artikel_add') ?>" class="btn btn-sm btn-primary btn-icon-split">
					<span class="icon">
				...
				<tbody>
					...
					?>
							<tr>
								...
								<td style="vertical-align: middle;"><img src="<?= base_url('assets/img/artikel/') . $x['image']; ?>" style="height: 70px;"></td>
								<td style="vertical-align: middle;"><?= $x['nama']; ?></td>
								<td style="vertical-align: middle;"><?= date('d F Y', strtotime($x['date_created']));?></td>
								<td style="vertical-align: middle; width:50px;"><?= $x['urut']; ?></td>
								<th style="width: 90px;text-align: center;vertical-align: middle;">
									<a href="<?= base_url('myadmin/menu/artikel_edit/') . $x['id'] ?>" class="btn btn-circle btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-edit"></i></a>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header bg-danger py-3">
					<h6 class="modal-title m-0 font-weight-bold text-white" id="exampleModalLabel">Delete Artikel</h6>
				...
				<div class="modal-footer py-2">
					<a href="<?= base_url('myadmin/menu/artikel_delete/') . $x['id']; ?>" class="btn btn-primary btn-sm btn-icon-split">
