...
<div class="container-fluid">
    ...
    <div class="clearfix">
		...
		<div class="float-right">
				<a href="<?= base_url('myadmin/menu/video') ?>" class="btn btn-sm btn-secondary btn-icon-split">
					<span class="icon">
				...
				<div class="card-body">
					...
					<div class="row form-group">
						...
						<div class="col-md-9">
							...
							<input type="text" name="nama" class="form-control" placeholder="Nama..." value="<?= $video['nama']; ?>" required>
					...
					<div class="row form-group">
						...
						<div class="col-md-9">
							<input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi..." value="<?= $video['deskripsi'];?>" required>
					...
					<div class="row form-group">
						...
						<div class="col-md-9">
							<input type="text" name="url" class="form-control" placeholder="URL..." value="<?= $video['url'];?>" required>
					...
					<div class="row form-group">
						...
						<div class="col-md-9">
							<input type="number" name="urut" class="form-control" placeholder="Urut..." value="<?= $video['urut'];?>" required>
