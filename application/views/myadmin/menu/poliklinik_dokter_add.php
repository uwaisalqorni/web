...
<div class="container-fluid">
    ...
    <div class="clearfix">
		...
		<div class="float-right">
				<a href="<?= base_url('myadmin/menu/poliklinik_dokter/') ?><?= $poliklinik_id ?>" class="btn btn-sm btn-secondary btn-icon-split">
					<span class="icon">
		...
		<div class="col-md-8">
			<div class="card shadow-sm border-bottom-primary">
				<div class="card-header">
					<h6 class="m-0 font-weight-bold text-primary">Add Dokter di Poliklinik "<?= $nama ?>"</h6>
				</div>
				<div class="card-body">
					<?= form_open(); ?>
					<div class="row form-group">
						...
						<div class="col-md-9">
							<input type="hidden" name="poliklinik_id" class="form-control" value="<?= $poliklinik_id; ?>">
