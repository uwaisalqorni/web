				...
				<div class="card-body">
					...
					<div class="row form-group">
						...
						<div class="col-md-9">
							...
							<input type="text" name="nama" class="form-control" placeholder="Nama..." value="<?= $layanan['nama']; ?>" required>
					...
					<div class="row form-group">
						...
						<div class="col-md-9">
							<input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi..." value="<?= $layanan['deskripsi'];?>" required>
							<?= form_error('deskripsi', '<small class="text-danger">', '</small>'); ?>
						</div>
					</div>
					<hr>
					<div class="row form-group">
						<label class="col-md-3" for="icon"><strong>Icon</strong></label>
						<div class="col-md-9">
							<input type="text" name="icon" class="form-control" placeholder="Icon..." value="<?= $layanan['icon'];?>" required>
