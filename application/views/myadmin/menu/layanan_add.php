		...
		<div class="col-md-8">
			<div class="card shadow-sm border-bottom-primary">
				...
				<div class="card-body">
					...
					<hr>
					<div class="row form-group">
						<label class="col-md-3" for="icon"><strong>FontAwesome Icon</strong></label>
						<div class="col-md-9">
							<input type="text" name="icon" class="form-control" placeholder="fas fa-hand-holding-medical" value="<?= set_value('icon'); ?>" required>
							<?= form_error('deskripsi', '<small class="text-danger">', '</small>'); ?>
						</div>
					</div>
					<hr>
