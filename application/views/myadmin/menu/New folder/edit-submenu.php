<div class="container-fluid">
    ...
    <?= form_open('myadmin/manage/editsub/' . $menu['id']); ?>
    <div class="modal-body">
        ...
        <div class="form-group">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="<?= $menu['is_active']; ?>" id="is_active" name="is_active" <?= active_check($menu['is_active'], $menu['id']); ?>>
