				...
				<tbody>
					...
					?>
							<tr>
								...
								<td style="vertical-align: middle;"><?= $m['is_active']; ?></td>
								<th style="width: 90px;text-align: center;vertical-align: middle;">
									<a href="<?= base_url('myadmin/manage/editsub/' . $m['id']); ?>" class="btn btn-circle btn-outline-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-edit"></i></a>
...
<div class="modal fade" id="Delete<?= $m['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Are you sure want to delete <?= $m['title']; ?> Submenu?</div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                <a class="btn btn-primary" href="<?= base_url('myadmin/manage/deletesub/') . $m['id']; ?>">Delete</a>
            </div>
        </div>
    </div>
</div>
