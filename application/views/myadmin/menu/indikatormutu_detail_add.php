...
<div class="container-fluid">
    ...
    <div class="clearfix">
		...
		<div class="float-right">
				<a href="<?= base_url('myadmin/menu/indikatormutu_detail/') ?><?= $indikatormutu_id ?>" class="btn btn-sm btn-secondary btn-icon-split">
					<span class="icon">
			...
			<div class="card shadow-sm border-bottom-primary">
				...
				<div class="card-body">
					...
					<div class="row form-group">
						...
						<div class="col-md-9">
							<input type="hidden" name="indikatormutu_id" class="form-control"value="<?= $indikatormutu_id; ?>">
					...
					<hr>
					<div class="row form-group">
						<label class="col-md-3" for="filefoto"><strong>Gambar</strong></label>
						<div class="col-md-9">
					...
					<div class="row form-group">
						...
						<div class="col-md-9">
							<input type="number" name="urut" class="form-control" placeholder="1" value="<?= set_value('urut'); ?>" required>
